...
class ControllerContainer extends BaseComponent_1.default {
    ...
    constructor(props) {
        const { id, classes, apiPlayer, ids } = props;
        super(props);
        this.bodyController = new BodyController_1.default({ id, classes, apiPlayer, ids });
        this.footerController = new FooterController_1.default({ id, classes, apiPlayer, ids });
