...
class BodyController extends BaseComponent_1.default {
    ...
    registerListener() {
        document.getElementById(constants_1.ids.smSettingsContainer)?.addEventListener('click', (event) => {
            event.preventDefault();
            event.stopPropagation();
        });
    }
...
const generateApiPlayer = (player, video, typePlayer, version) => {
    ...
    if (typePlayer === constants_1.ETypePlayer.SHAKA) {
        ...
        apiPlayer.removeEventListener = (evtName, clb) => {
            switch (evtName) {
                case type_1.EEVentName.LOADED:
                    player.removeEventListener(evtName, (data) => {
                        const dataConvert = (0, exports.convertDataEventLoaded)(data);
                        clb(dataConvert);
                    });
                    break;
...
exports.generateApiPlayer = generateApiPlayer;
...
class SmUIControls {
    ...
    constructor(props) {
        ...
        const apiPlayer = (0, services_1.generateApiPlayer)(player, video, typePlayer, version);
        this.apiPlayer = apiPlayer;
