...
import { EBreakpoint, TGenerateStylesProps } from '../../type';
import { primaryColorDef } from '../../constants';
const generateStylesMobile = (props?: TGenerateStylesProps) => {
  ...
  return {
    ...
    `,
    scrubbingRippleRightEnable: css`
      display: block;
    `,
    scrubbingRewind: css`
      position: relative;
...
export default generateStylesMobile;
