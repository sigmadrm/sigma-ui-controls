...
class TaskbarController extends BaseComponent {
  ...
  private buttonSetting: ButtonSetting | undefined;
  private buttonSubtitle: ButtonSubtitle | undefined;

  constructor(props: IConstructorProps) {
    const { classes, apiPlayer } = props;
    super(props);

    this.buttonSetting = new ButtonSetting({
      id: ids.smButtonSetting,
      classes,
      apiPlayer,
    });
    this.buttonSubtitle = new ButtonSubtitle({
      id: ids.smButtonSubtitle,
      classes,
      apiPlayer,
    });
